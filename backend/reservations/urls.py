...
urlpatterns = [
    ...
    path("persons/<int:person_id>/delete", views.PersonTemplateView.person_delete_view, name="person_delete"),
    ...
    path("buildings/<int:building_id>/", views.BuildingTemplateView.building_get_view, name="building_view"),
    ...
    path("buildings/create", views.BuildingTemplateView.building_create_view, name="person_create"),
    path(
    ...
    path("rooms/create", views.RoomTemplateView.room_create_view, name="person_create"),
    ...
    path("groups/create", views.GroupTemplateView.group_create_view, name="person_create"),
    ...
    path("reservations/create", views.ReservationTemplateView.reservation_create_view, name="person_create"),
    path(
